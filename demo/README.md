...
```bash
demo$ make run
demo$ curl http://localhost:3000/hello
```
...
```bash
demo$ sam logs -n HelloWorldFunction --stack-name <Name-of-your-deployed-stack> --tail
```
...
```bash
demo$ pipenv lock -r > hello_world/requirements.txt
```
